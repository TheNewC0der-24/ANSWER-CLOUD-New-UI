    ...
    return (
        ...
        <Card component={Stack} p={2} sx={{ backgroundColor: "#ffc106" }}>
            <CardContent sx={{ display: 'flex' }} direction={{ xs: 'column', sm: 'row', md: "row" }}>
                <Stack p={1} display={{ xs: 'none', sm: 'none', md: "block" }}><img src={loginImg} alt="login" style={{ width: '100%', height: '100%' }} /></Stack>
                <Stack p={4}><Typography variant="h4">How it works?</Typography>
